...
parser.add_argument('--config_file', type=str, default='./configs/sevent/adaptive_lc.json')
parser.add_argument('--model_path', type=str,
                    default='../trained_models/7T/7T_ADAPTIVE_LC/2024-04-21-03/ADAPTIVE_LC-15-epoch.pth')
